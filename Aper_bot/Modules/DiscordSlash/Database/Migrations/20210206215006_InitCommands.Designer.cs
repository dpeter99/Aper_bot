...
{
    [DbContext(typeof(SlashDbContext))]
    [Migration("20210206215006_InitCommands")]
    partial class InitCommands
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("SlashCommands")
            ...
            modelBuilder.Entity("Aper_bot.Database.Model.Guild", b =>
                {
                    ...
                    b.ToTable("Guild", "Aper_Bot", t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("Aper_bot.Database.Model.GuildPermissionLevel", b =>
                {
                    ...
                    b.ToTable("GuildPermissionLevels", "Aper_Bot", t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("Aper_bot.Database.Model.GuildRule", b =>
                {
                    ...
                    b.ToTable("GuildRules", "Aper_Bot", t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("Aper_bot.Database.Model.Image", b =>
                {
                    ...
                    b.ToTable("Images", "Aper_Bot", t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("Aper_bot.Database.Model.Quote", b =>
                {
                    ...
                    b.ToTable("Quotes", "Aper_Bot", t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("Aper_bot.Database.Model.User", b =>
                {
                    ...
                    b.ToTable("Users", "Aper_Bot", t => t.ExcludeFromMigrations());
                });

            modelBuilder.Entity("Aper_bot.Modules.DiscordSlash.Database.Model.Command", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Commands", "SlashCommands");
                });
