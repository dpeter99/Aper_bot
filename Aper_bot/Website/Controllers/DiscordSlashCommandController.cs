...
namespace Aper_bot.Website.Controllers
{
    ...
    public class DiscordSlashCommandController : ControllerBase
    {
        ...
        public DiscordSlashCommandController(ILogger<DiscordSlashCommandController> logger, DiscordBot bot)
        {
            _logger = logger;
            _discordBot = bot;
        }
        ...
        public async Task<IActionResult> DiscordEndpointHandler()
        {
            ...
            {// ... then pass the raw request body to the client ...
                /*
                var response = await _discordBot.SlashClient.HandleWebhookPost(raw);
